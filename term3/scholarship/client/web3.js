const contractAddress = "0x776b8Ba7f562c21fd845eDA44704596157b3bc0A"; 

const contractABI = [
	{ "inputs": [], "stateMutability": "nonpayable", "type": "constructor" },
	{ "anonymous": false, "inputs": [ { "indexed": true, "internalType": "address", "name": "applicant", "type": "address" } ], "name": "Applied", "type": "event" },
	...
	{ "inputs": [ { "internalType": "address", "name": "", "type": "address" } ], "name": "applicants", "outputs": [ { "internalType": "bool", "name": "", "type": "bool" } ], "stateMutability": "view", "type": "function" },
	{ "inputs": [], "name": "applyForScholarship", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
	{ "inputs": [], "name": "donate", "outputs": [], "stateMutability": "payable", "type": "function" },
	{ "inputs": [], "name": "getBalance", "outputs": [ { "internalType": "uint256", "name": "", "type": "uint256" } ], "stateMutability": "view", "type": "function" },
	{ "inputs": [ { "internalType": "address payable", "name": "recipient", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" } ], "name": "releaseFunds", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
...
async function releaseFunds() {
    ...
    if (!recipient) { alert("Please enter a recipient address"); return; }
    const amount = web3.utils.toWei('1', 'ether'); // Releases 1 ETH per click
    try {
        await contract.methods.releaseFunds(recipient, amount).send({ from: accounts[0] });
        alert("Funds released successfully!");
    } catch (error) {
        console.error("Fund release failed", error);
        alert("Error: Only the admin account can release funds.");
    }
}